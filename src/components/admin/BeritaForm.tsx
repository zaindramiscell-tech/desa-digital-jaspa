...
const formSchema = z.object({
  ...
  isi: z.any().refine((data: OutputData) => {
    return data && Array.isArray(data.blocks) && data.blocks.length > 0 && data.blocks.some(block => block.data && (block.data.text || block.data.caption));
            ...
            <Card>
              ...
              <CardFooter className="justify-end">
                 <Button type="submit" disabled={isSubmitting}>
                  ...
                  {isSubmitting ? 'Menyimpan...' : (berita ? 'Simpan Perubahan' : 'Publikasikan')}
                </Button>
              </CardFooter>
            </Card>
          </div>
